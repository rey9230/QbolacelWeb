          ...
          <div className="max-w-3xl mx-auto prose prose-neutral dark:prose-invert">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-8">
              ...
              <section>
                ...
                <ul>
                  <li><strong>Recargas Cubacel:</strong> Transferencia de saldo a líneas móviles en Cuba operadas por ETECSA.</li>
                  <li><strong>Recargas Nauta:</strong> Adición de tiempo de navegación a cuentas Nauta para acceso a internet.</li>
                  <li><strong>Tienda en Línea:</strong> Comercialización de productos físicos con entrega a domicilio en territorio cubano.</li>
                </ul>
              </section>
              ...
              <section>
                ...
                <p>
                  Qbolacel mantiene tolerancia cero ante actividades fraudulentas. Nos reservamos el derecho de:
                </p>
                <ul>
              ...
              <section>
                ...
                <p>
                  ...
                  acreditación del saldo en el destino depende de ETECSA, por lo que ocasionalmente pueden 
                  existir demoras ajenas a nuestro control.
                </p>
                <h3>5.2 Política de No Reembolso</h3>
                <p>
                  <strong>Las recargas son ventas finales y no reembolsables una vez procesadas.</strong> Es 
                  responsabilidad exclusiva del usuario verificar que el número telefónico o cuenta Nauta 
                  ingresado sea correcto antes de confirmar la operación.
                </p>
                <p>
                  Qbolacel no se hace responsable por errores en la digitación del número destino ni por 
                  recargas enviadas a números incorrectos.
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  Los productos adquiridos en nuestra tienda se entregan en la dirección indicada dentro del 
                  territorio cubano. Los plazos de entrega son estimados y pueden variar según la ubicación 
                  y disponibilidad.
                </p>
                <h3>6.2 Verificación de Entrega</h3>
                <p>
                  El beneficiario designado deberá verificar el estado del producto al momento de la entrega. 
                  Se dispone de un plazo de 7 días naturales desde la recepción para reportar cualquier 
                  inconformidad o daño.
                </p>
                <h3>6.3 Devoluciones</h3>
                <p>
                  Solo se aceptan devoluciones de productos que lleguen dañados o defectuosos. El cliente debe 
                  proporcionar evidencia fotográfica del problema. Los productos perecederos no son elegibles 
                  para devolución.
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  Todos los precios se expresan en dólares estadounidenses (USD). Aceptamos los siguientes 
                  métodos de pago:
                </p>
                <ul>
                  <li>PayPal</li>
                ...
                <p>
                  Los precios pueden modificarse sin previo aviso. El precio aplicable será el vigente al 
                  momento de confirmar la compra.
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  Todo el contenido de Qbolacel, incluyendo pero no limitado a marcas, logotipos, textos, 
                  imágenes, diseños y software, es propiedad de Qbolacel o sus licenciantes y está protegido 
                  por las leyes de propiedad intelectual aplicables.
                </p>
                <p>
                  Queda prohibida la reproducción, distribución o uso no autorizado de cualquier elemento 
              ...
              <section>
                ...
                <p>
                  Qbolacel proporciona sus servicios "tal como están". No garantizamos la disponibilidad 
                  ininterrumpida de la plataforma ni nos responsabilizamos por:
                </p>
                <ul>
              ...
              <section>
                ...
                <p>
                  Cualquier disputa relacionada con estos términos se resolverá de acuerdo con las leyes del 
                  Estado de Florida, Estados Unidos. Las partes acuerdan someterse a la jurisdicción exclusiva 
                  de los tribunales de dicho estado.
                </p>
              </section>
              ...
              <section>
                ...
                <ul>
                  <li><strong>Correo electrónico:</strong> qbolacel@gmail.com</li>
                  <li><strong>Teléfono:</strong> +1 (727) 276-0465</li>
                </ul>
                <p>
                  Nuestro equipo de atención al cliente está disponible de lunes a domingo, de 8:00 AM a 10:00 PM (hora del Este).
                </p>
              </section>
